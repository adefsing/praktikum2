<!-- ini halaman tampilan yang menampilkan form validation -->
...
<body>
    ...
    <!-- ini adalah baris kode yang memiliki tugas membuat form menggunakan helper form dari controller "Form/aksi"-->
